...
open class AdaptadorLugaresBD(lugares: LugaresBD, var cursor: Cursor): AdaptadorLugares(lugares) {
    ...
    fun posicionId(_id: Int): Int {
        var pos = 0
        while (pos < itemCount && idPosicion(pos) != _id) pos++
